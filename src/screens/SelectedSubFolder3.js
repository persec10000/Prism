...
export default class SelectedSubFolder3 extends React.Component {
    ...
    async GetAllVDR() {
        let params = this.props.navigation.state.params;
        console.log("params6==",params.FolderID);
        let folder;
    ...
    render() {
        ...
        // const selectedText1 = options1[selected1].component || options1[selected1];
